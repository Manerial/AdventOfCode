...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(8317), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(74765078), aocRunner.getSolution2().toString()));
    }
    ...
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(408679), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(3443939356L), aocRunner.getSolution2().toString()));
    }
}