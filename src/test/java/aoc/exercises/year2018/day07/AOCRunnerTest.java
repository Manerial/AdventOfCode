...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals("CABDFE", aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(253), aocRunner.getSolution2().toString()));
    }
    @Test
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals("ABDCJLFMNVQWHIRKTEUXOZSYPG", aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(896), aocRunner.getSolution2().toString()));
    }
}