...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(24000), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(45000), aocRunner.getSolution2().toString()));
    }
    @Test
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(70613), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(205805), aocRunner.getSolution2().toString()));
    }
}