...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(152), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(301), aocRunner.getSolution2().toString()));
    }
    ...
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(379578518396784L), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(3353687996514L), aocRunner.getSolution2().toString()));
    }
}