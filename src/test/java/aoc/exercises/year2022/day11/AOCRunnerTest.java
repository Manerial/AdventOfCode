...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(10605), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(2713310158L), aocRunner.getSolution2().toString()));
    }
    @Test
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(55458), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(14508081294L), aocRunner.getSolution2().toString()));
    }
}