...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(480), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(875318608908L), aocRunner.getSolution2().toString()));
    }
    ...
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(35255), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(87582154060429L), aocRunner.getSolution2().toString()));
    }
}