...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(37990510), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(23), aocRunner.getSolution2().toString()));
    }
    ...
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(19241711734L), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(2058), aocRunner.getSolution2().toString()));
    }
}