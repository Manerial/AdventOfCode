...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals("5,7,3,0", aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(117440), aocRunner.getSolution2().toString()));
    }
    ...
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals("4,0,4,7,1,2,7,1,6", aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(202322348616234L), aocRunner.getSolution2().toString()));
    }
}