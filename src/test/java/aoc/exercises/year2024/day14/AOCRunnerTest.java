...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(12), aocRunner.getSolution1().toString()),
                () -> assertEquals("NOT APPLICABLE", aocRunner.getSolution2().toString()));
    }
    ...
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(228457125), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(6493), aocRunner.getSolution2().toString()));
    }
}