...
class AOCRunnerTest {
    ...
    void test_example() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(381), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(241976), aocRunner.getSolution2().toString()));
    }
    ...
    void test_puzzle() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        aocRunner.run();
        assertAll(
                () -> assertEquals(String.valueOf(98135), aocRunner.getSolution1().toString()),
                () -> assertEquals(String.valueOf(10964557606L), aocRunner.getSolution2().toString()));
    }
}